                ...
                <div x-data="tabsMegaMenu()">
                  <ul class="flex justify-start items-center">
                    <template x-for="(tab, index) in tabs" :key="index">
                      <li class="cursor-pointer py-2 px-4 text-cdsolec-green-dark border-b-4 border-gray-400"
                        :class="activeTab===index ? 'text-cdsolec-green-dark border-cdsolec-green-dark' : ''" @click="activeTab = index" x-text="tab"></li>
                    </template>
                  </ul>
