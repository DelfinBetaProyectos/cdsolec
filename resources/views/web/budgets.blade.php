  ...
  <div class="max-w-7xl mx-auto mb-14 mt-6 lg:mt-8 sm:px-6 lg:px-8">
    <nav class="mb-3 px-3 py-2 rounded bg-gray-200 text-gray-600">
			<ol class="flex flex-wrap">
				...
				<li><span class="mx-2">/</span>Presupuestos</li>
			</ol>
		</nav>

		<div id="message" class="my-3 px-3 py-2 rounded bbudget bbudget-green-600 bg-green-200 text-green-600 text-sm font-bold" {{ (!session()->has('message')) ? 'hidden' : '' }}>
			{{ session()->has('message') ? session()->get('message') : '' }}
		</div>

		<div class="my-3 p-3 bg-white overflow-hidden bbudget bbudget-gray-200 shadow-lg sm:rounded-lg">
				...
				<div class="grid grid-cols-1 md:grid-cols-12 gap-3">
					...
					<div class="col-span-12 md:col-span-3">
						...
						<div class="relative flatpickrFrom">
							<input type="text" id="from" name="from" placeholder="Desde" value="{{ request('from') }}" class="w-full bbudget-gray-300 focus:bbudget-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow" readonly data-input />
					...
					<div class="col-span-12 md:col-span-3">
						...
						<div class="relative flatpickrTo">
							<input type="text" id="to" name="to" placeholder="Hasta" value="{{ request('to') }}" class="w-full bbudget-gray-300 focus:bbudget-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow" readonly data-input />
							<a class="input-button cursor-pointer" title="toggle" data-toggle>
								<i class="fas fa-calendar p-3 text-cdsolec-green-dark absolute right-0"></i>
							</a>
						</div>
					...
					<div class="col-span-12 md:col-span-1">
						<x-jet-button class="bbudget-none bg-blue-600">
                    ...
                    @foreach($budgets as $budget)
                        ...
                        <tr class="flex flex-col lg:table-row even:bg-gray-200">
                            ...
                            <td class="flex flex-row lg:table-cell">
                                ...
                                <div class="p-2 text-center">
                                    <a href="{{ route('budgets.show', $budget) }}" class="px-3 py-2 font-semibold uppercase text-sm text-white bg-blue-600 hover:bg-blue-500 tracking-wider rounded-md transition">
