...
<head>
  ...
  <title>Presupuesto {{ $propal->ref }}</title>
  ...
  <main>
    <table style="width: 100%; border-collapse: collapse;">
      <tr>
        ...
        <td style="width: 50%; text-align: right;">
          <h1>Presupuesto</h1>
          <h2>{{ $propal->ref }}</h2>
          <h4>Fecha: {{ $propal->datec->format('d/m/Y') }}</h4>
        </td>
      </tr>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 2em 0;">
      <tr>
        ...
        <td>&nbsp;</td>
        <td style="width: 48%; background-color: #D7D4E1; padding: .5em; vertical-align: top;">
          <h4>{{ $propal->society->nom }}</h4>
          <h4>RIF: {{ $propal->society->siren }}</h4>
          <br />
          <p>Teléfonos: {{ $propal->society->phone }}</p>
          <p>Email: {{ $propal->society->email }}</p>
        </td>
      </tr>
    </table>
      ...
      <tbody class="w-full flex-1 sm:flex-none bg-white divide-y divide-gray-400 text-sm leading-5">
        ...
        <tr style="background-color: #D7D4E1;">
          ...
          <td style="border: 1px solid #000000; padding: .5em; text-align: right;">
            ...
            <p>$USD {{ number_format($propal->total_ht, 2, ',', '.') }}</p>
          </td>
        </tr>
        @php
        ...
        <tr style="background-color: #D7D4E1;">
          ...
          <td style="border: 1px solid #000000; padding: .5em; text-align: right;">
            ...
            <p>$USD {{ number_format($propal->tva, 2, ',', '.') }}</p>
          </td>
        </tr>
        @php
        ...
        <tr style="background-color: #D7D4E1;">
          ...
          <td style="border: 1px solid #000000; padding: .5em; text-align: right;">
            ...
            <p><strong>$USD {{ number_format($propal->total, 2, ',', '.') }}</strong></p>
          </td>
        </tr>
      </tbody>
    </table>
