			...
			<div class="w-full shadow rounded-md overflow-hidden bg-white px-4 py-3 sm:px-6">
				<div class="grid gap-2 md:grid-cols-4 items-end">
					...
					<div class="justify-self-end pb-2">
						<a href="{{ route('budgets.pdf', $propal) }}" target="_blank" class="px-3 py-2 font-semibold uppercase text-sm text-white bg-green-600 hover:bg-green-500 tracking-wider rounded-md transition">
