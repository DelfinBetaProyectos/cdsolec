<x-web-layout title="Nosotros">
    ...
    <div class="container mx-auto px-6">
      ...
      <p class="py-2">Nuestra seriedad, responsabilidad y compromiso con los clientes, garantiza la continua operatividad y calidad de todos los sistemas diseñados, construidos y/o instalados según las Normativas Vigentes (ANSI, IEC, NEMA, NEC, NFPA, UL, ISA).</p>
			...
			<p class="py-2">PONER EN LA MANO DE NUESTROS CLIENTES PRODUCTOS Y SOLUCIONES INNOVADORAS PARA LLEVAR A TERMINO LOS PROYECTOS Y SERVICIOS EN EL MENOR TIEMPO POSIBLE, GARANTIZANDO SOSTENIBILIDAD, EFICIENCIA, SEGURIDAD Y RENTABILIDAD.</p>
    </div>
	@endsection
</x-web-layout>