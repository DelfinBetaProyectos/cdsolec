	...
	<div class="max-w-7xl mx-auto mb-14 mt-6 lg:mt-8 sm:px-6 lg:px-8">
		<nav class="mb-3 px-3 py-2 rounded bg-gray-200 text-gray-600">
			<ol class="flex flex-wrap">
				...
				<li><span class="mx-2">/</span>Categorias</li>
			</ol>
		</nav>
		...
		<div class="my-3 flex justify-end">
			<a href="{{ route('categories.create') }}" class="px-3 py-2 font-semibold uppercase text-sm text-white bg-green-600 hover:bg-green-500 tracking-wider rounded-md transition">
				<i class="fas fa-fw fa-plus-square"></i> Agregar Nuevo
			</a>
			<a href="{{ route('categories.trash') }}" class="ml-2 px-3 py-2 font-semibold uppercase text-sm text-white bg-red-600 hover:bg-red-500 tracking-wider rounded-md transition">
